...
# 训练配置(zdj)
train_cfg = dict(type='EpochBasedTrainLoop', max_epochs=150, val_interval=5)  # 50个周期，每5个周期验证一次
...
# 学习率调度器
param_scheduler = dict(type='MultiStepLR', by_epoch=True, milestones=[80], gamma=0.5)
#zdj